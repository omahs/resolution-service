...
| QUERY_BATCHING_ENABLED                      | true                                              | :x:                | Enables query batching for API endpoints                                                                                                                                                                                                                                                                    |
| QUERY_BATCHING_MAX_BATCH_SIZE               | 200                                               | :x:                | Maximum batch size                                                                                                                                                                                                                                                                 |
| QUERY_BATCHING_TIMEOUT_MS                   | 100                                               | :x:                | Timeout for batch collection. The batching library will wait for the specified number of milliseconds before performing any queries                                                                                                                                                                                                                                                                  |
| QUERY_BATCHING_CACHING_ENABLED              | true                                              | :x:                | Enables cache for batched queries                                                                                                                                                                                                                                                                 |

...
export const metaSVGTemplate = (
  ...
  const fontSize = '52'; //@TODO: determine font size using context.measureText()
  const domainName = 'markvital'; //@TODO extract the domain and implement domain name shortening up to 14px
  const extension = 'wallet'; //@TODO extract the extension
  return ` 
    <svg
      width="1200"
      height="630"
